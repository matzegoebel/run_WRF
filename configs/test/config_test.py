...
outpath = os.environ["wrf_res"] + "/" + runID #WRF output path root
...
start_time = "2018-06-20_00:00:00" #format %Y-%m-%d_%H:%M:%S
end_time = "2018-06-20_02:00:00" #format %Y-%m-%d_%H:%M:%S
...
params["input_sounding"] = "" #name of input sounding to use (final name is then created: input_sounding_$name)
