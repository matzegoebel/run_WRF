...
params["vmem"] = None
# buffer factor for virtual memory (not used for test runs or if vmem is given)
params["vmem_buffer"] = 1.5
...
# buffer factor to multiply rt with (not used for test runs or if rt is given)
params["rt_buffer"] = 2
...
# seconds before requested runtime is exhausted and signal is sent to job
params["send_rt_signal"] = 90
